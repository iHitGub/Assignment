...
public class TestRBTree {
	...
	private int OUT_OF_RANGE_INPUT = -100;

	@Before
	public void setUp() throws Exception {
	}

	// Below method commented out to allow maven build 
	/*
	@Test
	 ...
	 */
	@Test
	public void testInsertAndFind_OutOfRange() {
		RBTree t = new RBTree();
		for (int i = 0; i > OUT_OF_RANGE_INPUT; i--) {
			t.insert(i);
		}
		for (int i = 0; i > OUT_OF_RANGE_INPUT; i--) {
			assertTrue(t.find(i));
