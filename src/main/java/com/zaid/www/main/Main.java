...
public class Main {
	...
	private void initialize() {
		...
		JLabel dataStructuresTitle = new JLabel("Data structures verification");
		dataStructuresTitle.setFont(new Font("Tahoma", Font.BOLD, 12));
		...
		JLabel intro = new JLabel("The automated process for building installers was successful!!");
		intro.setBounds(35, 46, 700, 14);
		frame.getContentPane().add(intro);
		
		JLabel cList = new JLabel("This is just a demo! The list contains the following numbers: " + l.toString());
